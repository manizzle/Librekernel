...
It is not the way the internet functions, but the way we use it. All the technologies need to use it productively and simultanously enhance security and privacy are available, even free. So, to achieve data security **the users need a grid to have a resilence where** Know-how, reliability, technical and economical convenience -all of it integrated in a plug and play device- that is the added value we deliver. 
