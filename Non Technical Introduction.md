...
To be protected **you need the necessary infrastructure: a grid with resilence. Through the community grid the information is encrypted before leaving your computer, then is encrypted again and distributed in paths; impossible to be readen by anyone else excepted to .** Know-how, reliability, technical and economical convenience -all of it integrated in a plug and play device- that is the added value we deliver. https://ksr-video.imgix.net/projects/1830782/video-546980-h264_high.mp4
